...
/// @brief Compute the leftovers on both predictions and ground truth
/// @param goldPath , path where the segmentation images are stored
/// @param predPath , path where the predicted segmentation images are stored
void foodLeftoverEstimation(const std::string& goldPath, const std::string& predPath);

/// @brief show on screen the results for a tray
/// @param path , path for the tray
